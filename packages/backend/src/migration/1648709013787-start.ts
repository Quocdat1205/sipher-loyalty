...
export class start1648709013787 implements MigrationInterface {
  name = "start1648709013787";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "merchandise" ("id" SERIAL NOT NULL, "publicAddress" character varying NOT NULL, "tier" character varying NOT NULL, "merchItem" character varying NOT NULL, "quantity" integer NOT NULL, "quantityShipped" integer NOT NULL, "isShipped" boolean NOT NULL DEFAULT false, "shippable" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "itemId" integer, CONSTRAINT "PK_00e2fdb70d486a410d6825d7579" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
