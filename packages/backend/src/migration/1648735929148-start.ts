...
export class start1648735929148 implements MigrationInterface {
  name = "start1648735929148";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "erc1155_lootbox" ("id" SERIAL NOT NULL, "tokenId" integer NOT NULL, "name" character varying NOT NULL, "shortDescription" character varying NOT NULL DEFAULT '', "description" character varying NOT NULL DEFAULT '', "external_url" character varying NOT NULL DEFAULT 'https://sipher.xyz', "image" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_dee78353b4954921c94dbde1ac5" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "erc1155_sculpture" ("id" SERIAL NOT NULL, "tokenId" integer NOT NULL, "name" character varying NOT NULL, "shortDescription" character varying NOT NULL DEFAULT '', "description" character varying NOT NULL DEFAULT '', "external_url" character varying NOT NULL DEFAULT 'https://sipher.xyz', "image" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_c2b6f1a17f994502fa7a3e53a6e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "claimable_lootbox" ("id" SERIAL NOT NULL, "publicAddress" character varying NOT NULL, "quantity" integer NOT NULL DEFAULT '1', "tokenId" integer NOT NULL, "expiredDate" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "propertyLootboxId" integer, CONSTRAINT "PK_77b7190f0846a5fef9a1b852225" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "item" ("id" SERIAL NOT NULL, "merchItem" character varying NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "shortDescription" character varying, "description" character varying array NOT NULL DEFAULT '{}', "size" character varying array DEFAULT '{}', "color" character varying array DEFAULT '{}', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "merchandise" ("id" SERIAL NOT NULL, "publicAddress" character varying NOT NULL, "tier" character varying NOT NULL, "merchItem" character varying NOT NULL, "quantity" integer NOT NULL, "quantityShipped" integer NOT NULL DEFAULT '0', "isShipped" boolean NOT NULL DEFAULT false, "shippable" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "itemId" integer, CONSTRAINT "PK_00e2fdb70d486a410d6825d7579" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
