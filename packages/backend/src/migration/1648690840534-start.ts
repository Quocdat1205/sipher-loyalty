...
export class start1648690840534 implements MigrationInterface {
  name = "start1648690840534";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "erc1155_lootbox" ("id" SERIAL NOT NULL, "tokenId" character varying NOT NULL, "name" character varying NOT NULL, "shortDescription" character varying NOT NULL DEFAULT '', "description" character varying NOT NULL DEFAULT '', "external_url" character varying NOT NULL DEFAULT 'https://sipher.xyz', "image" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_dee78353b4954921c94dbde1ac5" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "erc1155_sculpture" ("id" SERIAL NOT NULL, "tokenId" character varying NOT NULL, "name" character varying NOT NULL, "shortDescription" character varying NOT NULL DEFAULT '', "description" character varying NOT NULL DEFAULT '', "external_url" character varying NOT NULL DEFAULT 'https://sipher.xyz', "image" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_c2b6f1a17f994502fa7a3e53a6e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
