...
import { EIP712_BATCH_ORDER_TYPES, EIP712_DOMAIN_TEMPLATE, EIP712_ORDER_TYPES } from "./constants"
...
const signBatchOrder = async (
  ...
  const signature = await signer._signTypedData(domain, types, encodeBatchOrder(batchOrder))

  return signature
}

export { createEIP712Domain, encodeBatchOrder, signBatchOrder, signer, signOrder }
