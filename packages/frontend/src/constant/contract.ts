export const INU_ADDRESS = process.env.NEXT_PUBLIC_SC_INU || "0x4d91fa57abfead5fbc8445e45b906b85bbd9744c" //test

export const NEKO_ADDRESS = process.env.NEXT_PUBLIC_SC_NEKO || "0x97c8480d593b93ae90f8613a5b2ac02e7a3dd0ed" //test
...
export const SipherLootBoxAddress = process.env.NEXT_PUBLIC_SC_LOOTBOX || "0x3E445D426c8FdE12F5F0C223019CA9158f7Da93B" //test

export const SipherSculptureAddress =
  process.env.NEXT_PUBLIC_SC_SCULPTURE || "0X3EDB954303D0A13EE347C6989189294B0422E7D6" // test
