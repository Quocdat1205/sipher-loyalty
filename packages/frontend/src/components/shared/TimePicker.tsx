...
export const TimePicker = ({ value: timePickerValue, onChange, onFocus, ...flexProps }: Props) => {
  ...
  return (
    <Flex flex={1} h="40px" bg="neutral.600" justify="space-between" borderRadius="4px" align="center" {...flexProps}>
      ...
      <Select
        ...
        w="5rem"
        icon={
          <Box w="auto!important" h="auto!important" color="#7c7d91!important" transform={"auto"} rotate="180deg">
