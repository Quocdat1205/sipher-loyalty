...
import { CustomInput, CustomTextarea } from "."
...
export const SettingModal = ({ choose, onClose, setChangeForm }: SettingAccountModalProps) => {
  return (
    <Box px={6}>
      <Flex mb={8} align="center">
        ...
        <Box ml={8}>
          ...
          <Button size="md" color="neutral.50" border="none" bg="neutral.600" onClick={() => setChangeForm("AVATAR")}>
            <Flex align="center">
      ...
      <Flex py={6} role="group" cursor="pointer" justify="space-between" align="center">
        <Box>
